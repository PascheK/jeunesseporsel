...
const AccueilTheatre = () => {
  return (
    <section className='size-full flex items-center justify-center bg-jeunesse text-jeunesse-white ' id='accueil-theatre'>
      ...
      <div className=''>
        <Image src='/assets/images/theatre_affiche.jpg' alt='affiche théatre' width={'350'} height={'150'}/>
      </div>
      </div>
